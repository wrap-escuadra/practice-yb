        ...
        <div class="center-panel">
          <div class="row">              
                ...
                <div style="float:left; width:200px;" >         
                  <span class="school_title">ICNHS</span>  <br>          
                  <span class="school_address" style="line-height:12px;">Iloilo City National High School </span>                
                </div>                    
      ...
      <div class="col-sm-3" style="padding:10; border-radius: 3px 3px 0px 0px;">
        ...
        <div class="left-panel-profile-name">
            ...
            <p class="myprofile_name-txt" style="text-align:left;">
              <span class="glyphicon glyphicon-star"></span> Batch 2017
            </p>
            <div style="border-top: 1px solid #d8e5ee; padding-top:10px; margin-top:10px;"></div>
            <p class="myprofile_name-txt" style="text-align:left;">
              <span class="glyphicon glyphicon-education"></span> Batchelor of Science in Information Technology
            </p>
            <div style="border-top: 1px solid #d8e5ee; padding-top:10px; margin-top:10px;"></div>
            <p class="myprofile_name-txt" style="text-align:left;">
              <span class="glyphicon glyphicon-tag"></span> Den2x
            </p>
            <div style="border-top: 1px solid #d8e5ee; padding-top:10px; margin-top:10px;"></div>
            <p class="myprofile_name-txt" style="text-align:left;">
              <span class="glyphicon glyphicon-calendar"></span> February 5, 1990
            </p>
        </div>
        ...
        <div class="left-panel">
            ...
            <p class="ad_txt" style="text-align:left;">
              <img src="images/achievements_ribbon.svg" alt="achievment_icon" height="15px;"> Champion Quiz Bee 2015 - ISAT Foundation
            </p>
            <div style="border-top: 1px solid #d8e5ee; padding-top:10px; margin-top:10px;"></div>
            <p class="ad_txt" style="text-align:left;">
              <img src="images/achievements_ribbon.svg" alt="achievment_icon" height="15px;"> Dean's Lister 1st Simester
            </p>
            <div style="border-top: 1px solid #d8e5ee; padding-top:10px; margin-top:10px;"></div>
            <p class="ad_txt" style="text-align:left;">
              <img src="images/achievements_ribbon.svg" alt="achievment_icon" height="15px;"> Miss ISAT 2015 1st runner-up
            </p>
          ...
          <div class="row">
            ...
            <div class="col-md-6" style="padding:0;">
              <div class="col-xs-6" style="border-width:1px;border-color:#9caab5;border-style:solid; padding:0;">
                <img src="images/gradphotos/dane-grad03.jpg" alt="Logo" width="100%">
              </div>
              <div class="col-xs-6" style="border-width:1px;border-color:#9caab5;border-style:solid; padding:0;">
