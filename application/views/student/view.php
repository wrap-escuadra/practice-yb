        ...
        <div style="border-top: 1px solid #d8e5ee; padding-top:10px; margin-top:10px;"></div>
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="col-xs-2" align="center" style="padding-right:0;">
                <img src="<?=base_url('assets/_uploads/profile_headers/thumbnail/thumb_'.$comment['img']);?>" alt="profile image thumb" width="100%" style="border-radius: 50%;">
              </div>
              <div class="col-xs-10">
                <div class="ad_txt">
                  <blockquote> 
          ...
          <div>
            <div id="comments" class="row">
              <form action="<?=site_url('student/profile/'.iencode($user['profile_id']));?>" method="post">
                <div class="col-xs-12">
